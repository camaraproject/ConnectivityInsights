Feature: CAMARA Connectivity Insights Subscriptions API, v0.7.0-rc.1 - Operations for Subscriptions
...
# References to OAS spec schemas refer to schemas specified in connectivity-insights-subscriptions.yaml
  ...
  Background: Common Connectivity Insights Subscriptions setup
    Given the resource "{apiroot}/connectivity-insights-subscriptions/v0.7rc1" as base-url
